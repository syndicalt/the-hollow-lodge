...
PROJECTION_READ_SURFACE_ENVS = {
    ...
    "contract_unlocks": "HOLLOW_LODGE_CONTRACT_UNLOCK_PROJECTION_READS",
    ...
    "identity_admin": "HOLLOW_LODGE_IDENTITY_ADMIN_PROJECTION_READS",
    "oracle_audits": "HOLLOW_LODGE_ORACLE_AUDIT_PROJECTION_READS",
    ...
    "proof_fragments": "HOLLOW_LODGE_PROOF_FRAGMENT_PROJECTION_READS",
    "rumors": "HOLLOW_LODGE_RUMOR_PROJECTION_READS",
